ArcGIS API for JavaScript（3.x）如何加载天地图《[ArcGIS API for Javascript 加载天地图（经纬度投影） - 张凯强 - 博客园](https://www.cnblogs.com/zhangkaiqiang/p/7358627.html)》这篇文章已经写的很好了，但放到4.x上没法用，这里我将他的方法升级到4.x版本供大家参考。（4.x修改了挺多东西）
